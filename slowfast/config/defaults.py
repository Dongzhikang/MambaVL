...
# 
_C.SSV2.DATA_ROOT = 'datasets/Something-SomethingV2'
_C.SSV2.SPLITS_ROOT = "/datasets/Something-SomethingV2/ssv2_splits" # Path to the folder that contains the "dataset_splits" dir provided in "Something-Else"
