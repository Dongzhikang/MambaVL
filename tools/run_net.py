...
import sys
sys.path.append("/srv/essa-lab/flash3/zdong302/state_change_detection/ORViT")
import os
...
from test_net_ant import test as test_ant
...
def main():
    ...
    if cfg.TEST.ENABLE:
        if cfg.TRAIN.DATASET == "epickitchens" and cfg.EPICKITCHENS.ANTICIPATION:
            launch_job(cfg=cfg, init_method=args.init_method, func=test_ant)
        else:
